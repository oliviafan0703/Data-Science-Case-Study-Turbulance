...
When the flow is laminar, Re and Fr are both low, the probability distribution for particle cluster volumes is spread out, highly skewed, and is heavily influenced by outliers. When the flow is turbulent, the probability distribution for particle cluster volumes is fairly normal, symmetric, and with few outliers. 

The standard error of our results explode when all three parameters are high. In future study, we hope to address this issue and explore how to produce more accurate prediction.
