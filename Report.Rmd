...
From the SE columns, we can see that the 1st raw moment has very small standard error and low uncertainty. The uncertainty increases as moments increases--higher order moments generally have higher uncertainty than lower order moments. This means that our prediction on the mean is the most accurate, and prediction on kurtosis is less reliable. It is worth-noticing that SE are the highest when St, Fr, Re are all high.
